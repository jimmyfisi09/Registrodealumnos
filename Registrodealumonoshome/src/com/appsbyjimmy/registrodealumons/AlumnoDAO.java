...
public class AlumnoDAO extends SQLiteOpenHelper{
	...
	public void onCreate(SQLiteDatabase db) {
		String dll="CREATE TABLE Alumnos (id INTEGER PRIMARY KEY,"+
	...
	public void eliminar(Alumno alumno) {
		...
		this.getWritableDatabase().delete("Alumnos","id=?",args);
	...
	public void modificaralumno(Alumno alumno) {
		...
		values.put("foto",alumno.getFoto());
		String[]args={alumno.getId().toString()};
		this.getWritableDatabase().update("Alumnos",values,"id=?",args);
